  ...
  <tr>
    <td width="50%">
      <div align="center">
        <h3>🕒 ClockMaster</h3>
        <p>
          Web app with local clock, alarms, world clock, timer and stopwatch – built with modern, responsive UI.
        </p>
    ...
    <td width="50%">
      <div align="center">
        <h3>📌 Task_Master_Full_Project</h3>
        <p>
          Powerful task management app for creating, updating, filtering and tracking tasks with deadlines & priorities.
        </p>
